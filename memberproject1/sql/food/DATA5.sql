...
--------------------------------------------------------
  ...
  CREATE TABLE "BBARONI"."RECIPE_DATA5_TBL" 
   (	"NUM" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BBARONI"."SYS_C007158" ON "BBARONI"."RECIPE_DATA5_TBL" ("NUM") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "BBARONI"."RECIPE_DATA5_TBL" ADD PRIMARY KEY ("NUM")
