...
--------------------------------------------------------
  ...
  CREATE TABLE "BBARONI"."RECIPE_DATA3_TBL" 
   (	"NUM" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BBARONI"."SYS_C007161" ON "BBARONI"."RECIPE_DATA3_TBL" ("NUM") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "BBARONI"."RECIPE_DATA3_TBL" ADD PRIMARY KEY ("NUM")
