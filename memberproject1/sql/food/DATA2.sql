...
--------------------------------------------------------
  ...
  CREATE TABLE "BBARONI"."RECIPE_DATA2_TBL" 
   (	"NUM" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BBARONI"."SYS_C007162" ON "BBARONI"."RECIPE_DATA2_TBL" ("NUM") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "BBARONI"."RECIPE_DATA2_TBL" ADD PRIMARY KEY ("NUM")
